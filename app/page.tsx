...
const heading = "font-[family-name:var(--font-heading)] font-semibold text-forest-ink";
    ...
    <main>
      ...
      <section className="bg-lichen">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
          <div>
            ...
            <p className="mt-6 text-lg text-forest-ink">
      ...
      <section id="what-a-walk-is" className="bg-birch">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <p className="mt-6 max-w-2xl text-lg text-forest-ink">
            Most people hear guided walk and picture a hike. This is the
            opposite of a hike.
          </p>

          <div className="mt-12 flex flex-col gap-10 md:max-w-2xl">
            {[
              {
                title: "We gather",
              ...
              <div key={step.title} className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-lg text-forest-ink">{step.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="dates" className="bg-lichen">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <Button href="/dates" variant="secondary" className="mt-10">
            See all dates
          </Button>
        </div>
      </section>
      ...
      <section id="guide" className="bg-birch">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
          ...
          <div>
            ...
            <p className="mt-6 max-w-md rounded-md border border-dashed border-loam bg-lichen/40 p-4 text-lg text-forest-ink">
      ...
      <section id="why-it-works" className="bg-deep-moss">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <h2 className="mt-4 font-[family-name:var(--font-heading)] text-3xl font-semibold text-birch sm:text-4xl">
            Forest bathing, in plain terms.
          </h2>
          <p className="mt-6 max-w-2xl text-lg text-birch">
      ...
      <section id="bedrock-babes" className="bg-birch">
        <div className="mx-auto max-w-2xl px-6 py-24 text-center md:py-40">
          ...
          />
          <Button href="/bedrock-babes" variant="secondary" className="mt-10">
            About Bedrock Babes
          </Button>
        </div>
      </section>
      ...
      {/* 7. Corporate */}
      <section id="corporate" className="bg-loam">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <p className="mt-6 max-w-2xl text-lg text-birch">
            A talk on the health benefits of time in nature, open to anyone
            at your organization. Guided walks for teams are available in
            season.
          </p>
